...
BOT_TOKEN = os.getenv("Bot-Token ထည့်")
GITHUB_TOKEN = os.getenv("Github-Tikenထည့်")
REPO_OWNER = os.getenv("Repo owner ထည့်")
REPO_NAME = os.getenv("Repo nameထည့်")
ADMIN_ID = os.getenv("Admin IDထည့်")
